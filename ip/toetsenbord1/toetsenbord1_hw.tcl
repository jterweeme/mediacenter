...
add_interface_port avalon_slave_0 s_cs_n chipselect_n Input 1
...
add_interface_port conduit_end sseg0 export Output 7
add_interface_port conduit_end sseg1 export Output 7
