...
set_module_property DATASHEET_URL "doc/RS232.pdf"
...
proc elaborate {} {
	...
	if { $avalon_bus_type == "Memory Mapped" } {
		...
		# | 
		add_interface avalon_rs232_slave avalon end clock_reset
		...
		# | 
		add_interface avalon_data_receive_source avalon_streaming start clock_reset
		...
		# | 
		add_interface avalon_data_transmit_sink avalon_streaming end clock_reset
